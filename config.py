...
BOT_NAME = getenv("BOT_NAME" , "AARU MUSIC")
ASSUSERNAME = getenv("ASSUSERNAME" , "II_AARU_II")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/tu-mera-dusman/CHATNI-GIRL",)
